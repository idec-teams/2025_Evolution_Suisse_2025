...
![DML Plasmid](../img/Color_coded_Whole_Cell_View.jpeg){width=0.6} Figure 1: DE of IS621 using EcORep. **A** depicts the mutagenesis plasmid, the O-Replicon and the selection
